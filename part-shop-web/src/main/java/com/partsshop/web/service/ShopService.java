...
public class ShopService {
	...
	public ResponseEntity<String> getShopsFromRest() {
		...
		res =  this.restTemplate.exchange(String.format("%s%s", this.partShopRest, "/shops/"), HttpMethod.GET, requestEntity, String.class);
		return res ; 
	}
